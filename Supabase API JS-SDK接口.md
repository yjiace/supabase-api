...
## 检索存储桶
文档：https://supabase.com/docs/reference/javascript/storage-getbucket

## 列出所有存储桶
文档：https://supabase.com/docs/reference/javascript/storage-listbuckets

## 更新存储桶
文档：https://supabase.com/docs/reference/javascript/storage-updatebucket

## 删除存储桶
文档：https://supabase.com/docs/reference/javascript/storage-deletebucket

## 清空一个桶
文档：https://supabase.com/docs/reference/javascript/storage-emptybucket

## 上传文件
文档：https://supabase.com/docs/reference/javascript/storage-from-upload

## 下载文件
文档：https://supabase.com/docs/reference/javascript/storage-from-download

## 列出存储桶中的所有文件
文档：https://supabase.com/docs/reference/javascript/storage-from-list

## 替换现有文件
文档：https://supabase.com/docs/reference/javascript/storage-from-update

## 移动现有文件
文档：https://supabase.com/docs/reference/javascript/storage-from-move

## 复制现有文件
文档：https://supabase.com/docs/reference/javascript/storage-from-copy

## 删除存储桶中的文件
文档：https://supabase.com/docs/reference/javascript/storage-from-remove

## 创建签名 URL
文档：https://supabase.com/docs/reference/javascript/storage-from-createsignedurl

## 创建签名 URL（批量）
文档：https://supabase.com/docs/reference/javascript/storage-from-createsignedurls

## 创建签名上传 URL
文档：https://supabase.com/docs/reference/javascript/storage-from-createsigneduploadurl

## 上传到签名的 URL
文档：https://supabase.com/docs/reference/javascript/storage-from-uploadtosignedurl

## 检索公共 URL
文档：https://supabase.com/docs/reference/javascript/storage-from-getpublicurl
